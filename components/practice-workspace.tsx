...
export function PracticeWorkspace({
  ...
  const isBusy =
    phase === 'submitted' || phase === 'evaluating'
  ...
  function handleSubmit() {
    ...
    if (codeIsEmpty) {
      setError(
        'Your Java solution is empty. Write your design before submitting.',
      )
      return
    }
          ...
          <div>
            ...
            >
              ...
              <span className="ml-2 font-normal text-muted-foreground">
                Explain your responsibilities, abstractions,
                trade-offs, and extensibility decisions
              </span>
            </label>
  ...
  return (
    <div className="flex flex-col gap-6 py-4">
      ...
      {phase === 'completed' && attempt ? (
        ...
        <p className="text-sm text-muted-foreground">
          Hang tight — your solution is moving through the
          pipeline.
        </p>
      )}
    </div>
